...
const greeting = {
  ...
  full_name: "Jegan",
  subTitle:
    "A resourcefull MERN and Mobile App Developer with 1.5 years of experience.",
  // resumeLink:
  //   "https://drive.google.com/file/d/1YEK55fEZLSs2qBCvrh7VPUrsupPmvezo/view?usp=drive_link",
  mail: "mailto:sjegan1005@gmail.com",
};

const socialMediaLinks = {
  /* Your Social Media Link */
  github: "https://github.com/Jegan-1005",
  linkedin: "https://www.linkedin.com/in/s-jegan-082711210/",
  gmail: "sjegan1005@gmail.com",
...
const skills = {
  data: [
    {
      title: "MERN / Mobile App Developer",
      fileName: "FullStackImg",
      skills: [
        "⚡ Develop highly interactive User Interfaces Apps and Websites",
        "⚡ Building responsive website front end using ReactJS",
        "⚡ Developing responsive Apps using React Native",
...
const experience = {
  title: "Experience",
  subtitle: "Wealwin Technologies Pvt.Ltd , Madurai",
  description: " — MERN Stack and Mobile App Developer (1.5 Years)",
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to create NodeJS Backend Projects, React Native, and React Project. Below are some of my projects.",
  ...
  data: [
    {
      ...
      description: "OrbitX is an Initial Coin Offering using cryptocurrencies.",
      languages: [
        {
          name: "HTML5",
    ...
    {
      id: "2",
      name: "TradeArt (Solana NFT)",
      // url: "https://github.com/vvHacker007/Tune-In",
      description:
        "Trade art is a revolutionary NFT marketplace currently allowing users to buy/sell Solana-based NFTs without any listing fees.",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      description: "Pyramidion is an Product NFT marketplace.",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    {
      id: "4",
      name: "Millionero (MobileApp)",
      url: "https://github.com/vvHacker007/Movie-Recommendation-Systems",
      description:
        "Millionero is a Platform that allows traders to buy and sell cryptocurrencies, derivatives and other crypto-related assets.",
      languages: [
        {
          name: "Python",
          iconifyClass: "logos-python",
    ...
    {
      id: "5",
      name: "Invajt (MobileApp)",
      url: "https://github.com/vvHacker007/Login-Authenticator",
      description:
        "Invajt is an Event invite app which allows users to create events and share to their friends.",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
